...
export default function OrderSuccess() {
  ...
  const CLEAR_CART = "https://watchkart-be.onrender.com/api/clear-cartitems";

  function clearCartItems() {
    axios.delete(CLEAR_CART).then(
      (response) => {},
      (error) => {
        console.log(error);
      }
  ...
  return (
    <div>
      {isMobile ? (
        ...
        <div className={Style.homeIcon} onClick={() => navigate("/")}>
      ...
      <div className={Style.successCardContainer}>
        <div className={Style.successCard}>
          <div>
            ...
            <div className={Style.orderPlacedMessage}>
